...
module.exports.loop = function () {
    ...
    var longDistanceTargetRooms = ['W42N51','W44N51','W41N52','W44N52','W43N52','W43N49','W42N49','W43N48','W41N49','W41N48','W42N46','W42N44','W41N45','W43N45','W42N47','W45N51'];
    ...
    var longDistanceTargetRoomsHomeRooms = ['null','null','null','null','null','null','null','null','W42N48','null','null','null','null','null','null','null'];
                            ...
                            if(myRooms[currentRoomIndex].memory.need[needIndex] > myRooms[currentRoomIndex].memory.attached[needIndex]) {
                                ...
                                if(myRooms[currentRoomIndex].memory.role[needIndex] == 'upgrader') {
                                    if(myRooms[currentRoomIndex].controller.level == 8) {
                                        ...
                                        for(let j = 0; j< Math.floor((capacityToBeUsed - (upgraderCarryMoveParts * 100)) / 100) && j< (50 - upgraderCarryMoveParts); j++) {
