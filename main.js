...
module.exports.loop = function () {
    ...
    var longDistanceTargetRooms = ['W42N51','W44N51','W41N52','W44N52','W43N52','W43N49','W42N49','W43N48','W41N49','W41N48','W42N46','W42N44','W41N45','W43N45','W42N47'];
    // Number of source to harvest in each room
    var longDistanceTargetRoomsSources = [1,1,1,1,1,1,1,2,1,1,2,2,1,1,1];
    // Carrys needed for each room
    var longDistanceTargetRoomsCarryNeeded = [1,2,2,1,2,1,2,3,1,1,3,1,1,1,1];
    // If the harvesters should be able to defend themselves
    var longDistanceTargetRoomsAgressive = [false,false,false,false,false,false,false,false,false,false,false,false,false,false];
    // Home rooms spawning creeps. If "null", then automatically computed.
    var longDistanceTargetRoomsHomeRooms = ['null','null','null','null','null','null','null','null','W42N48','null','null','null','null','null','null'];
    ...
    var longDistanceBuildRoomsBuilders = [0,2];
